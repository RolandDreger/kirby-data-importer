...
},{}],"components/ImportDataField.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    __onInput: function __onInput(value) {
      this.$emit("input", value);
    },
    __selectFile: function __selectFile(_event) {
      var _this = this;

      this.$api.get(this.endpoints.field + '/get/files').then(function (files) {
        _this.$refs.filesDialog.open(files, {
          multiple: false
        });
    ...
    __importData: function __importData(_filesDialogResultArray) {
      var _this2 = this;

      if (!_filesDialogResultArray || !(_filesDialogResultArray instanceof Array) || _filesDialogResultArray.length === 0) {
        return false;
      }
      ...
      if (!_selectedFileID || !_selectedFileURL) {
        console.log({
          "error": "File id oder url undefined."
        });
        return false;
      }
      ...
      if (!this.$route || !this.$route.hasOwnProperty('params')) {
        console.log({
          "error": "$route property »params« undefined."
        });
        return false;
      }
      ...
      if (!_subPageTemplate) {
        console.log({
          "error": "Template for subpages is undefined."
        });
        return false;
      }
      ...
      this.$api.post(this.endpoints.field + '/import/data', _postObj).then(function (_response) {
        if (_response != null && _response.hasOwnProperty("data") && _response.data instanceof Array && _response.data.length !== 0) {
          var _pageSection = __getItemByName(_this2.$root, _this2.subpage_section);
...
function __getItemByName(_parent, _targetName) {
  ...
  if (!_targetName || _targetName.constructor !== String) {
    return null;
  }
  ...
  if (_parent.hasOwnProperty("_props") && _parent._props.hasOwnProperty("name") && _parent._props.name === _targetName) {
    return _parent;
  }
  ...
  for (i = 0; i < _children.length; i += 1) {
    ...
    if (_child.hasOwnProperty("_props") && _child._props.hasOwnProperty("name") && _child._props.name === _targetName) {
      return _child;
    }
...
/* END function __getItemByName  */
        var $bcfe77 = exports.default || module.exports;
      
      if (typeof $bcfe77 === 'function') {
        $bcfe77 = $bcfe77.options;
      }
    
        /* template */
        Object.assign($bcfe77, (function () {
          var render = function() {
  var _vm = this
    ...
    [
      _c(
        "k-field",
        {
          ...
          attrs: { label: _vm.button_headline, help: _vm.button_help }
        },
        [
          _c(
            "k-button",
            {
              ref: "importButton",
              attrs: { theme: "positiv", icon: "import", responsive: "true" },
              on: { click: _vm.__selectFile }
            },
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: !_vm.options_disabled,
              expression: "!options_disabled"
            }
          ],
          attrs: { label: _vm.options_headline, help: _vm.options_help }
        },
        [
          _c("k-input", {
            staticClass: "import-mode-radio",
            attrs: { type: "radio", name: "radio", options: _vm.options_text },
            on: { input: _vm.__onInput },
            model: {
              value: _vm.value,
              callback: function($$v) {
                _vm.value = $$v
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bcfe77', $bcfe77);
          } else {
            api.reload('$bcfe77', $bcfe77);
          }
        }
...
var _ImportDataField = _interopRequireDefault(require("./components/ImportDataField.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

/* Panel code */
panel.plugin("rd/data-importer", {
  fields: {
    import_data: _ImportDataField.default
  }
});
},{"./components/ImportDataField.vue":"components/ImportDataField.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
